...
class MySprite(pygame.sprite.Sprite):
    ...
    def load(self, filename, width, height, columns):
        ...
        self.master_image = pygame.transform.flip(self.master_image, True, False)
...
dragon.load("Chapter 7\\dragon.png", 130, 150, 3)
dragon.position = 100, 230
group.add(dragon)

# 由于上面编写的load方法会翻转图片，导致野人反过来了，可以改一下方法，加个要不要翻转的参数
# create the player sprite
player = MySprite(screen)
player.load("Chapter 7\\caveman.png", 50, 65, 4)
...
arrow.load("Chapter 7\\bomb.png", 31, 31, 8)
...
while True:
    ...
    print_text(font, 350, 560, "Press SPACE tp jump!")
